        ...
        <>
            {!result && selectmode === false && question?.options.map((option, index) => (
                <Button
                    ...
                    className={`justify-start w-full h-auto py-4 mb-4 rounded hover:bg-gray-200 ${selectedChoices?.includes(index)
                ...
                >
                    <div className="flex items-center justify-center">
                        ...
                        <div className="text-start text-wrap">{option}</div>
                    </div>
            ...
            {result && selectmode === false && question?.options.map((option, index) => {
                ...
                return <Button
                    ...
                    className={`justify-between w-full h-auto py-4 mb-4 rounded hover:bg-gray-200 ${correctAnswer.includes(index) ? "bg-green-400 text-white hover:bg-green-500 hover:text-white" : selectedChoices.includes(index) && !correctAnswer.includes(index)
