            ...
            isOpen && (
                <div className="md:hidden">
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        <Link href="/mock-tests/results">
                            <div className="text-black hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Results</div>
                        </Link>
                        <Link href="/study">
                        ...
                        {(profile?.role === "admin" || profile?.role === 'teacher') && <div className="text-black hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium" onClick={handleClick}>{profile.role === 'teacher' ? "Teacher view" : "Dashboard"}</div>}
                        <Link href="/blog">
                        ...
                        {!profile ? <Button className="w-full bg-strong text-white px-3 py-2 hover:bg-blue-500/90 hover:text-white/80 rounded-md text-sm font-medium" onClick={handleSignIn}>
                            Login
                        </Button>
                            :
